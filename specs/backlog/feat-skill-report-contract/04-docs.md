...
- [ ] Add a short paragraph to `packages/common/assets/rules/spec-planning.md`
...
- [ ] Add the same, shorter, to `packages/common/assets/claude-md-section.md`,
      which is written into every consumer's `CLAUDE.md`.
- [ ] Update `README.md`, `packages/common/README.md`,
      `packages/skitterspec*/README.md` and `docs/index.html` — one worked block
      is worth more than a description of one.
- [ ] Run `scripts/docs-claims.test.js` and fix anything it catches; add a
