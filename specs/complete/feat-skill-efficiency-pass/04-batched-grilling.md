...
- [x] Amend `/spec` Phase A: replace "Ask one question at a time" with — batch
...
- [x] Amend `/spec-review` §3 (which points at `/spec` Phase A style) to match.
- [x] Rebuild dists (`pnpm build`).
- [x] Add/extend tests covering this phase (docs-claims-style retired-phrase
