...
- [ ] Run the invariant over this repo's own spec corpus (`specs/**/[0-9][0-9]-*.md`)
      as a single test — a real corpus, not just fixtures.
- [ ] Decide and document what the invariant does with a genuinely unparseable
...
- [ ] GREEN — invariant passes on the fixed parser and across the corpus.
