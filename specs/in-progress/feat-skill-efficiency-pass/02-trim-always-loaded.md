...
- [ ] Rewrite all 13 skill descriptions (9 in `packages/common/assets/skills`,
...
- [ ] Slim `packages/common/assets/claude-md-section.md` to the everyday loop
