...
- [ ] In `packages/common/assets/rules/spec-planning.md`, add `Impact` to the
...
- [ ] In `packages/common/assets/skills/spec-review/SKILL.md`, add an Impact-map
...
- [ ] Extend `assets.test.js`: assert `spec-planning.md` mentions the Impact
