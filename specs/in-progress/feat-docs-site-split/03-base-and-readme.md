...
- [x] Replace the Linear-flavoured "Get started" on `index.html` with a **base**
...
- [x] Add the missing rows to the command reference: `/spec-linear-setup` and
      `/spec-sync`, both in the Linear group.
- [x] Correct the reference's framing that the Linear group "only lights up when
