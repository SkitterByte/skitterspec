...
- [ ] Write `packages/common/assets/rules/spec-reports.md`. It carries, and only
...
- [ ] Include a worked example per verdict state, short enough to be read whole.
- [ ] Confirm no code change is needed to install it — `init.js` discovers
...
- [ ] Teach `packages/common/test/assets-prose.test.js` to **discover**
...
- [ ] Check the new rule against the emphasis rule (no `**bold**`, `*italic*` or
